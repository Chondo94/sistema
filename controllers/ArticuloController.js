...
export default {
    ...
    query: async (req,res,next) => {
        try {
            ...
            // aca voy a poblar categoria donde hago referencia a esta, y solo le pido que me mueste el nombre.
            // obtenemos los datos del articulo y el nombre de la categoria
